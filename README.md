...
> [!NOTE]
> * This project will never contain unvalidated AI generated code. It may take good advice from anywhere!
> * If you are looking for an AI/LLM interface to this project, see [MCP-SST](https://github.com/markburgess/MCP-SST) to run a proxy connector. If you would like to see an AI generated website of documentation for this project, generated by Mike Svoboda/NVIDIA see [Mike's-SSTorytime](https://mikesvoboda.github.io/SSTorytime/)
