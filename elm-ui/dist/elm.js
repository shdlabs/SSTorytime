...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{searchQuery: '', searchResult: '', status: 'Ready to explore Semantic SpaceTime'},
...
var $author$project$Main$GotSearchResult = function (a) {
...
var $author$project$Main$searchSSTorytime = function (query) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$multipartBody(
				_List_fromArray(
					[
						A2($elm$http$Http$stringPart, 'name', query)
					])),
			expect: $elm$http$Http$expectString($author$project$Main$GotSearchResult),
		...
		switch (msg.$) {
			...
			case 'PerformSearch':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{status: 'Searching the knowledge graph...'}),
					$author$project$Main$searchSSTorytime(model.searchQuery));
			default:
				var result = msg.a;
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{searchResult: response, status: 'Search completed - exploring semantic connections'}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								searchResult: 'Error: ' + $author$project$Main$httpErrorString(error),
...
var $author$project$Main$PerformSearch = {$: 'PerformSearch'};
...
var $author$project$Main$resultsSection = function (result) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Semantic SpaceTime Results:')
					])),
				A2(
				$elm$html$Html$pre,
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'font-family', 'Monaco, Consolas, monospace'),
						A2($elm$html$Html$Attributes$style, 'font-size', '14px'),
						A2($elm$html$Html$Attributes$style, 'line-height', '1.4'),
						A2($elm$html$Html$Attributes$style, 'white-space', 'pre-wrap'),
						A2($elm$html$Html$Attributes$style, 'color', '#f8f9fa')
					]),
				_List_fromArray(
					[
...
var $author$project$Main$welcomeSection = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			A2($elm$html$Html$Attributes$style, 'background', 'rgba(255, 255, 255, 0.1)'),
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Welcome to Semantic SpaceTime')
				])),
			A2(
			$elm$html$Html$p,
			_List_fromArray(
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Explore knowledge through Promise Theory with 3D nodes, spherical connections, and temporal dimensions.')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('• 3D nodes positioned in XYZ coordinates')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('• Spherical connections with longitude/latitude positioning')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('• 5 Arrow types from Promise Theory (Causality, Dependency, Similarity, Hierarchy, Association)')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('• Time representation with continuity context')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
							_List_fromArray(
								[
									$elm$html$Html$text('• Interactive exploration of semantic relationships')
								]))
						]))
				]))
		]));
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'padding', '30px'),
				A2($elm$html$Html$Attributes$style, 'font-family', 'Inter, -apple-system, BlinkMacSystemFont, sans-serif'),
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($elm$html$Html$Attributes$style, 'padding', '25px'),
						A2($elm$html$Html$Attributes$style, 'border-radius', '15px'),
						A2($elm$html$Html$Attributes$style, 'backdrop-filter', 'blur(10px)'),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('SSTorytime - Semantic SpaceTime Explorer')
							])),
						A2(
						$elm$html$Html$p,
						_List_fromArray(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Promise Theory Graph Visualization with Spherical Connections')
							]))
					])),
				A2(
				$elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$placeholder('Enter search query (e.g., \'moon\', \'reasoning\', \'brains\')'),
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$PerformSearch),
										A2($elm$html$Html$Attributes$style, 'padding', '15px 25px'),
										A2($elm$html$Html$Attributes$style, 'background', 'rgba(255, 255, 255, 0.2)'),
										A2($elm$html$Html$Attributes$style, 'color', 'white'),
										A2($elm$html$Html$Attributes$style, 'border', '2px solid rgba(255, 255, 255, 0.3)'),
										A2($elm$html$Html$Attributes$style, 'border-radius', '10px'),
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Explore SpaceTime')
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Status: ' + model.status)
							]))
					])),
				$elm$core$String$isEmpty(model.searchResult) ? $author$project$Main$welcomeSection : $author$project$Main$resultsSection(model.searchResult)
			]));
};
