...
exports.repr = exports.format = exports.flatMap = exports.map = exports.nullOr = exports.undefinedOr = exports.recursive = exports.multi = exports.tuple = exports.tag = exports.taggedUnion = exports.field = exports.fields = exports.record = exports.array = exports.primitiveUnion = exports.string = exports.bigint = exports.number = exports.boolean = exports.unknown = exports.JSON = void 0;
const CodecJSON = {
...
exports.primitiveUnion = primitiveUnion;
    ...
    return {
        decoder: (value) => {
            const encodedNameResult = fields({
                [encodedCommonField]: exports.unknown,
            }).decoder(value);
