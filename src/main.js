...
function DisplayError(message) {
  ...
  main.innerHTML = `<div class="text-center p-8 bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-300 rounded-lg shadow-md border border-red-300 dark:border-red-700">
